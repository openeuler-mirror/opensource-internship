...
def load_model(args, param_fpath):
    ...
    if args.model_selection == 'all':
        from main.approaches.post2vec.models.model_all import MultiComp

        model = MultiComp(args)
    elif args.model_selection == 'title':
        from main.approaches.post2vec.models.model_title import MultiComp

        model = MultiComp(args)
    elif args.model_selection == 'title_desc_text':
        from main.approaches.post2vec.models.model_title_desc_text import MultiComp
