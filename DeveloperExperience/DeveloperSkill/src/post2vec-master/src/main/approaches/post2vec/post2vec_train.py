...
############################# tuned parameter #############################
parser.add_argument('-model-selection', type=str, default='all',
...
if args.model_selection == 'all':
    from main.approaches.post2vec.models.model_all import MultiComp, train

    model = MultiComp(args=args)
elif args.model_selection == 'title':
    from main.approaches.post2vec.models.model_title import MultiComp, train

    model = MultiComp(args=args)

elif args.model_selection == 'title_desc_text':
    from main.approaches.post2vec.models.model_title_desc_text import MultiComp, train
